...
from miro_boost.common.settings import get_settings
from miro_boost.db.sqlite_storage import SQLiteStorage
...
class SessionManager:
    ...
    def get_redirect_url(
        ...
        return (
            # 認証・認可後のアプリURL.
            f"{settings.APP_URL}/auth/signed"
        )
    ...
    def refresh_auth(self, user_id: str) -> bool:
        ...
        try:
            ...
            logger.error("Unexpected error %s: %s", user_id, e)
            return False
        return True
